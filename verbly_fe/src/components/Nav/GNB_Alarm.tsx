  ...
  return (
    <div className="flex flex-col w-[369px] h-[344px] bg-white py-[20px] rounded-[12px] shadow-[0_4px_8px_0_rgba(0,0,0,0.08)]">
      <div className="flex flex-row justify-center items-center h-[28px] p-[14.5px]  gap-[105px]">
        ...
        <span className="flex flex-row items-center px-[4px] gap-[4px]">
          <img src="../../src/assets/check.svg" className="w-[20px] h-[20px]" />
          Mark all read
        </span>
      </div>
      <div className="flex flex-row items-center gap-[8px] w-[369px] h-[63px] px-[8px] py-[12px] border-b-[1px] border-[#F3F3F3]">
        <div className="w-[8px] h-[8px] bg-violet-700 rounded-[50px]" />
        <div className="flex flex-col justify-center">
          <div className="text-[16px]">Jisu liked your post.</div>
          <div className="text-[14px]">5m ago</div>
        </div>
      </div>
      <div className="flex flex-row items-center gap-[8px] w-[369px] h-[63px] px-[8px] py-[12px] border-b-[1px] border-[#F3F3F3]">
        <div className="w-[8px] h-[8px] bg-violet-700 rounded-[50px]" />
      ...
      <div className="text-center text-[14px]">View all notifications</div>
    </div>
  );
}
