            ...
            <div
              ...
              className={`
                ...
                ${isSelected 
                  ...
                  : 'bg-white border-2 border-gray-2 hover:border-violet-100'
                }
              `}
            >
              <div className="flex justify-between items-start mb-3 md:mb-4 lg:mb-[1rem]">
                <span className="text-[18px] font-semibold text-violet-40 uppercase tracking-wide">
                  {option.period}
                </span>
              ...
              <div className="text-left">
                <div className="text-3xl md:text-4xl lg:text-[2.5rem] font-bold text-violet-40 mb-2 lg:mb-[0.5rem] leading-none">
                  {option.price}
                </div>
                <div className="text-sm md:text-base lg:text-[1rem] text-gray-5">
                  {option.description}
                </div>
              </div>
            </div>
