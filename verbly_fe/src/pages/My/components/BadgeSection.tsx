  ...
  return (
    <div className="w-full h-[214px] bg-white rounded-xl shadow-sm border border-gray-100 p-4 md:p-6">
      <div className="flex justify-start items-center mb-4 md:mb-6 gap-[8px]">
        <img src={FireIcon} alt="sort" className="w-6 h-6 md:w-8 md:h-8" />
        <h3 className="text-lg md:text-[20px] text-gray-900">뱃지 관리</h3>
      </div>
      ...
      <div className="flex flex-start gap-3 md:gap-4">
        {badges.map((badge) => (
          ...
          >
            {/* 뱃지 이미지 영역 */}
            <div className="w-16 h-16 sm:w-20 sm:h-20 md:w-[88px] md:h-[88px] rounded-lg md:rounded-[12px] flex items-center justify-center bg-gray-50 border border-gray-100 transition-all overflow-hidden">
              <img 
