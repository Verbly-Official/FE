          ...
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 max-w-7xl">
            ...
            <div className="flex-1 space-y-6 lg:space-y-8">
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8">
                <div className="flex items-center gap-2 mb-6">
                  <Badge content="number" variant="primary" count={1} />
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8">
                <div className="flex items-center gap-2 mb-6">
                  <Badge content="number" variant="primary" count={2} />
                  <h2 className="text-[24px] text-gray-7 font-bold">
                    Payment Information
                  </h2>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                  <OutlinedButton
                    ...
                    className={
                      paymentMethod === "card"
                        ? "border-violet-50 bg-violet-100"
                        : ""
                    }
                  />
                  <OutlinedButton
              ...
              <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
                ...
                <label className="flex items-start gap-3 mb-6 cursor-pointer group">
                  ...
                  <span className="text-sm text-gray-600 leading-tight">
                    ...
                    {/* [수정됨] Subsription -> Subscription */} Subscription
                    auto-renew...
                  </span>
                </label>
