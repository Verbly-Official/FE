...
//     <aside className="w-[240px] bg-white">
//       <div className="mb-6">
//         <p className="flex items-start text-[#9E9E9E] pb-[8px] text-[17px] font-semibold leading-[100%] font-pretendard">
//           내 문서
//         </p>
//         <div className="space-y-2">
//           <SideMenu_Tab
...
//           />
//           <SideMenu_Tab
//             isSelected={active === "favorites"}
//             onClick={() => setActive("favorites")}
//           />
//           <SideMenu_Tab
//             isSelected={active === "recent"}
