  ...
  mistakes: [
    {
      ...
      explanation: '"Nevertheless" is used to show contrast despite the previous statement.',
    },
    {
      id: '2',
      word: 'intricate',
      ...
      explanation: '"Intricate" means having many complex details, so "complex" is the appropriate synonym.',
    },
  ],
  addedWords: [
